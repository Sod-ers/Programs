...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Favorites                | %path% HAS Z:\Songs\ AND %rating% PRESENT AND %rating% IS 5 OR %path% HAS Z:\ Songs-Archived\ AND %rating% PRESENT AND %rating% IS 5                                                  | %ALBUM ARTIST% - %DATE% - %ALBUM% - %DISCNUMBER% - %TRACKNUMBER% - %TITLE% |
...
| 3-4 Stars                | %path% HAS Z:\Songs\ AND %rating% PRESENT AND %rating% GREATER 2 AND %rating% LESS 5 OR %path% HAS Z:\Songs-Archived\ AND %rating% PRESENT AND %rating% GREATER 2 AND %rating% LESS 5 | %ALBUM ARTIST% - %DATE% - %ALBUM% - %DISCNUMBER% - %TRACKNUMBER% - %TITLE% |
